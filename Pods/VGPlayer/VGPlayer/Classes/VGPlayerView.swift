...
extension VGPlayerView {
    ...
    @objc open func reloadPlayerView() {
        self.playerLayer = AVPlayerLayer(player: nil)
    ...
    open func reloadGravity() {
        if self.vgPlayer != nil {
            ...
            case .resizeAspectFill:
                self.playerLayer?.videoGravity = AVLayerVideoGravity(rawValue: "AVLayerVideoGravityResizeAspectFill")
            }
        }
    }
...
extension VGPlayerView {
    ...
    @objc open func configurationUI() {
